    ...
    def __init__(self, sess, vocab):
        ...
        X = np.concatenate((
            tf.keras.preprocessing.sequence.pad_sequences(
                X, args.max_len+1, truncating='post', padding='post'),
            tf.keras.preprocessing.sequence.pad_sequences(
        ...
        self.train_iterator, self.train_init_dict = pipeline_train(enc_inp, dec_inp, dec_out, sess)
